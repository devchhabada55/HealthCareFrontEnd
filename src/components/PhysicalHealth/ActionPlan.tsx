...
const ActionPlan: React.FC<ActionPlanProps> = ({ isAdmin = false, isEditMode = false }) => {
  const [actionItems, setActionItems] = useState<ActionItem[]>([
    { id: '1', text: 'Continue physiotherapy for back pain', category: 'immediate' },
    { id: '2', text: 'Start with 20-minute daily walks', category: 'immediate' },
    { id: '3', text: 'Begin basic stretching routine', category: 'immediate' },
    { id: '4', text: 'Increase VO2 max to 38 ml/min/kg', category: 'short-term' },
    { id: '5', text: 'Achieve 15 consecutive push-ups', category: 'short-term' },
    { id: '6', text: 'Exercise 3 times per week consistently', category: 'short-term' },
  ]);
