...
import { Upload, FileText, Eye, Trash2, X, CheckCircle, User, Activity, FileUp, Database, Download } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              <img src={logo} alt="2H Health Centre Logo" className="w-auto h-14" /> {/* Added logo */}
              <div>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 w-full max-w-md">
            ...
            <div className="mt-8 flex justify-end space-x-3">
              <button
                onClick={() => setShowAdminDetailsModal(false)}
                className="px-5 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg font-medium transition-colors duration-200"
              >
                Cancel
              </button>
              <button
                ...
                className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors duration-200 shadow-md"
              >
                Save Changes
              </button>
            </div>
